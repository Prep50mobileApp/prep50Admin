                  ...
                  <div class="dropdown-menu-header">
                    <div class="dropdown-menu-header-inner bg-secondary">
                      <div
                        ...
                        style="
                          background-image: url('/images/dropdown-header/abstract2.jpg');
                        "
                      ></div>
                  ...
                  <div class="dropdown-menu-header">
                    <div class="dropdown-menu-header-inner bg-success">
                      <div
                        ...
                        style="
                          background-image: url('/images/dropdown-header/abstract3.jpg');
                        "
                      ></div>
                      <div class="menu-header-content text-left">
                        ...
                        <div class="menu-header-btn-pane">
                          ...
                          <button
                            class="btn-icon btn-icon-only btn btn-warning btn-sm"
                          >
                  ...
                  <div class="dropdown-menu-header">
                    <div class="dropdown-menu-header-inner bg-plum-plate">
                      <div
                        ...
                        style="
                          background-image: url('/images/dropdown-header/abstract4.jpg');
                        "
                      ></div>
                  ...
                  <div class="dropdown-menu-header">
                    <div class="dropdown-menu-header-inner pt-4 pb-4 bg-focus">
                      <div
                        ...
                        style="
                          background-image: url('/images/dropdown-header/city2.jpg');
                        "
                      ></div>
      ...
      <div class="app-main">
           ...
           <div class="scrollbar-sidebar">
            <div class="app-sidebar__inner">
              <ul class="vertical-nav-menu">
                ...
                <li>
                  <a href="#">
                    <i class="metismenu-icon pe-7s-plugin"></i>Home
                    <i
                  ...
                  <ul>
                    <li>
                      <router-link :to="{ name: 'register-list' }">
                        <i class="metismenu-icon"></i>Registered
                      
                    </router-link>
                    </li>
                    <li>
                       <router-link :to="{ name: 'subscribers' }">
                        <i class="metismenu-icon"></i>Subscribers
                      
                    </router-link>
                     
                    </li>
                    <li>
                      <router-link :to="{ name: 'unsubscribers' }">
                          <i class="metismenu-icon"></i>Unsubscribers
                        <i
                          class="metismenu-state-icon pe-7s-angle-down caret-left"
                        ></i>
                ...
                <li>
                  <a href="#">
                    <i class="metismenu-icon pe-7s-car"></i> Manage Blog
                    <i
                      class="metismenu-state-icon pe-7s-angle-down caret-left"
                    ></i>
                  </a>
                  <ul>
                    ...
                    <li>
                      <router-link :to="{ name: 'manage-blog' }">
                        <i class="metismenu-icon"></i>Manage Post
                    ...
                    <li>
                      <router-link :to="{ name: 'create-blog' }">
                        <i class="metismenu-icon"></i>Create Post
                    ...
                    <li>
                      <a href="#">
                        <i class="metismenu-icon"></i>Draft
                      </a>
                    </li>
                ...
                <li class="app-sidebar__heading">Podcast</li>
                <li>
                  <a href="#">
                    <i class="metismenu-icon pe-7s-ball"></i>Home Podcast
                    <i
                      class="metismenu-state-icon pe-7s-angle-down caret-left"
                    ></i>
                  </a>
                    ...
                    <li>
                      <router-link :to="{ name: 'manage-podcast' }">
                        <i class="metismenu-icon"></i>Manage Podcast
                      
                    </router-link>
                     
                    </li>
                    <li>
                      <router-link :to="{ name: 'create-podcast' }">
                        <i class="metismenu-icon"></i>Create Podcast
                ...
                <li>
                  <a href="#">
                    <i class="metismenu-icon pe-7s-light"></i>Manage referral
                    <i
                      class="metismenu-state-icon pe-7s-angle-down caret-left"
                    ></i>
                  </a>
                  <ul>
                    <li>
                      <router-link :to="{ name: 'manage-referral' }">
                        <i class="metismenu-icon"></i>Referrals
                ...
                <li class="app-sidebar__heading">Mock</li>
                <li>
                  <a href="#">
                    <i class="metismenu-icon pe-7s-graph2"></i>Home Mock
                    <i
                      class="metismenu-state-icon pe-7s-angle-down caret-left"
                    ></i>
                  </a>
                    ...
                    <li>
                      <a href="#">
                        <i class="metismenu-icon"></i>Manage Mock
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i class="metismenu-icon"></i>Create Mock
                      </a>
                    </li>
                  </ul>
                </li>
        ...
        <div class="app-main__outer">
          <div class="app-main__inner">
                ...
                <div class="page-title-heading">
                  <div>
                    <div class="page-title-head center-elem">
                      ...
                      <span class="d-inline-block">Admin Dashboard</span>
                    </div>
            ...
            <div
              class="mbg-3 alert alert-info alert-dismissible fade show"
              role="alert"
            >
              <span class="pr-2">
                <i class="fa fa-question-circle"></i>
              </span>
              Welcome to Prep50 Mobile App Admin dashboard where You can manage all the acivity in the app!
            </div>
            <div class="row">
                      ...
                      <div class="widget-numbers mt-2 fsize-4 mb-0 w-100">
                        <div class="widget-chart-flex align-items-center">
                          <div>
                            ...
                            34
                            <small class="opacity-5 pl-1">registered</small>
                          </div>
                          <div
                            class="widget-title ml-auto font-size-lg font-weight-normal text-muted"
                          >
              ...
              <div class="app-footer__inner">
                <div class="app-footer-left">
                  <div class="footer-dots">
                    ...
                    class="dropdown-item active"
                  >
                    <span class="mr-3 opacity-8 flag large NG"></span> NIGERIA
                  </button>
                        <div tabindex="-1" class="dropdown-divider"></div>
                        <h6 tabindex="-1" class="dropdown-header">Others</h6>
                          <button
                          ...
                          <div class="dropdown-menu-header">
                            ...
                            >
                              <div
                                class="menu-header-image opacity-1"
                                style="
                                  background-image: url('/images/dropdown-header/city5.jpg');
                                "
                              ></div>
                              <div class="menu-header-content text-dark">
            ...
            <div class="row">
              ...
              <div class="col">
                <div class="progress-box">
                  <h4>Server Load 2</h4>
                  <div
                    class="circle-progress circle-progress-success-xl mx-auto"
                  >
                    <small></small>
                  </div>
                </div>
              ...
              <div class="col">
                <div class="progress-box">
                  <h4>Server Load 3</h4>
                  <div
                    class="circle-progress circle-progress-danger-xl mx-auto"
                  >
                    <small></small>
                  </div>
                </div>
...
<script>
 export default {
    ...
    //   Script.setAttribute("src", "./scripts/js.js")
