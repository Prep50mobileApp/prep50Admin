          ...
          <ul class="header-megamenu nav">
            ...
            <li class="dropdown nav-item">
              ...
              <div
                ...
                aria-hidden="true"
                class="
                  dropdown-menu-rounded dropdown-menu-lg
                  rm-pointers
                  dropdown-menu
                "
              >
          ...
          <div class="header-dots">
            ...
            <div class="dropdown">
              ...
              >
                ...
                <ul
                  class="
                    tabs-animated-shadow tabs-animated
                    nav nav-justified
                  ...
                  <div class="widget-content-wrapper">
                    ...
                    <div class="widget-content-right widget-content-actions">
                      <button
                        class="
                          border-0
                          btn-transition btn btn-sm btn-outline-success
                        "
                      >
                        <i class="fa fa-check"></i>
                      </button>
                      <button
                        class="
                          border-0
                          btn-transition btn btn-sm btn-outline-danger
                        "
                      >
                        <i class="fa fa-trash-alt"></i>
                      </button>
